...
export default async function EventDetailPage({
  ...
  return (
    <ParentDashboardLayout
      ...
      initialIncidents={[incident as Incident]}
    >
      <div className="min-h-screen bg-paper text-slate-700 font-sans pb-12 rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
